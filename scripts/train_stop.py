...
for tub in os.listdir('data_stop_positive'):
    for image_file in os.listdir('data_stop_positive/'+tub+'/images'):
        img = Image.open(f'data_stop_positive/{tub}/images/{image_file}')
        img = np.asarray(img)
        img = img[10:-50,20:-20,:]
        images.append(img)
        labels.append(1)
...
for tub in os.listdir('data_stop_negative'):
    for image_file in os.listdir('data_stop_negative/'+tub+'/images'):
        img = Image.open(f'data_stop_negative/{tub}/images/{image_file}')
        img = np.asarray(img)
        img = img[10:-50,20:-20,:]
        images.append(img)
        labels.append(0)
...
for i, image_file in enumerate(os.listdir('data3/tub_1_23-01-24/images')):
        img = Image.open(f'data3/tub_1_23-01-24/images/{image_file}')
        img = np.asarray(img)
        img = img[10:-50,20:-20,:]
        images.append(img)
        labels.append(0)
        
for i, image_file in enumerate(os.listdir('data3/tub_1_23-01-24_brightAug/images')):
        img = Image.open(f'data3/tub_1_23-01-24_brightAug/images/{image_file}')
        img = np.asarray(img)
        img = img[10:-50,20:-20,:]
        images.append(img)
        labels.append(0)
