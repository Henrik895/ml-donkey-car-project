...
for tub in os.listdir('data_right_hand_positive'):
    for image_file in os.listdir('data_right_hand_positive/'+tub+'/images'):
        img = Image.open(f'data_right_hand_positive/{tub}/images/{image_file}')
        img = np.asarray(img)
        img = img[60:90,80:,:]
        images.append(img)
        labels.append(1)
...
for tub in os.listdir('data_right_hand_negative'):
    for image_file in os.listdir('data_right_hand_negative/'+tub+'/images'):
        img = Image.open(f'data_right_hand_negative/{tub}/images/{image_file}')
        img = np.asarray(img)
        img = img[60:90,80:,:]
        images.append(img)
        labels.append(0)
...
plt.ioff()
plt.savefig("history_right_hand.png")
plt.show()